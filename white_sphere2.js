...
'  gl_FragColor = vec4((fragColor.xyz + adjustedNormal) * 0.6, 1.0);',
'}'
].join('\n');
...
var InitDemo = function () {
	...
	var viewModel = new Float32Array(16);
	...
	function calculateNormalMatrix(){
		mat4.multiply(viewModel, viewMatrix, worldMatrix);
		mat3.normalFromMat4(normalMat,viewModel);
	}
	function click(){
	...
	var loop = function () {
		...
		for (i = 0; i <= currentBacteriaNumber; i++) {
			createSphere(10,20,2.5,[0.5,0.3,0.8]);
			drawSphere();
